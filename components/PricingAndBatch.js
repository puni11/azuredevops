    ...
    <section id='pricing' className="max-w-7xl mx-auto font-lexend py-20 px-6 sm:px-0 text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch animate-roll">
        ...
        >
          ...
          {/* Primary CTA */}
        <a id='enroll_now_pricing' href='https://rzp.io/rzp/sM9Ufce' target='_blank' className="group relative overflow-hidden flex items-center justify-center w-full md:w-auto px-18 py-3.5 text-sm md:text-base font-bold text-gray-50 rounded-md cursor-pointer bg-gradient-to-b from-gray-700 to-gray-950 shadow-lg">
